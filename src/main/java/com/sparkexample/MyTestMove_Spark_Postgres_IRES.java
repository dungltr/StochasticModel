 ...
 * @author letrung
 */
public class MyTestMove_Spark_Postgres_IRES {
    ...
    public void testMove_Spark_Postgres_IRES(String IRES_library, String NameOfHost, int int_localhost) throws Exception {
        String OperatorFolder = IRES_library+"/target/asapLibrary/operators/";
        String AlgorithmsName = "SQL_query";
        String NameOfAbstractWorkflow = "Move_Spark_Postgres_IRES_Workflow";
        String NameOfAbstractOperator = "Spark_Postgres_IRES";
        String NameOp = "Move_Spark_Postgres_IRES";
...
"\n" +
"SPARK_PORT=local[*]\n" +
"SQL_QUERY=\"DROP TABLE IF EXISTS $TABLE; CREATE TABLE IF NOT EXISTS $TABLE $SCHEMA; COPY $TABLE FROM '/mnt/Data/tmp/$TABLE/$TABLE.csv' WITH DELIMITER AS '|';\"\n" +
"\n" +
