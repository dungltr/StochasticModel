 ...
 * @author letrung
 */
public class TestSparkDatabase {
  // $example on:create_ds$
...
//    SparkConf sparkConf = new SparkConf();//
    SparkConf sparkConf = new SparkConf().setAppName("cust data").setMaster("local[*]");
...
*/    // $example off:init_session$
        SparkSession spark;
        spark = SparkSession.builder().appName("cust data").config(sparkConf).getOrCreate();
//              spark.builder();
