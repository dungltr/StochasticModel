 ...
 * @author letrung
 */
public class MyTestMove_Postgres_Spark_IRES {
    ...
    public void testMove_Postgres_Spark_IRES(String IRES_library, String NameOfHost, int int_localhost) throws Exception {
        ...
        String NameOfAbstractWorkflow = "Move_Postgres_Spark_IRES_Workflow";
        String NameOfAbstractOperator = "Move_Postgres_Spark";
        String NameOp = "Move_Postgres_Spark_IRES";
		...
		op.add("Constraints.Output.number", "1");
                ...
                mop1.add("Execution.Output0.path", "hdfs://localhost:9000/user/hive/warehouse/lines.out");
                mop1.add("Execution.copyFromLocal","/mnt/Data/tmp/customer.csv");
                mop1.add("Execution.copyToLocal", "In0.path");
                mop1.add("Execution.command","./Move_Postgres_Spark_IRES.sh");
