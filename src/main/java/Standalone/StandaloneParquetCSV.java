 ...
 * @author letrung
 */
public class StandaloneParquetCSV {
...
"    main()";
    ...
    public String CSV2Parquet (String DataIn) {
        String Data = DataIn.toLowerCase();
        String customer = "customer";
        if (Data.indexOf("customer")>=0) customer = DataIn;
...
"                df.printSchema()\n" +
"                try:\n" +
"                	df.write.save(namenode + warehouse + \"/\" + output + \".parquet\", format = \"parquet\")\n" +
