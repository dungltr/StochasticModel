...
public class runWorkFlowIRES {
    ...
    public void createOperatorMove(Move_Data Data, String SQL, double costEstimateValue) throws IOException, Exception {
        ...
        mop1.add("Optimization.model.execTime",  "gr.ntua.ece.cslab.panic.core.models.LinearRegression");//AbstractWekaModel");//UserFunction");//AbstractWekaModel");//UserFunction");
